...
var _video = __webpack_require__(427);
...
var Article = function (_Component) {
    ...
    _createClass(Article, [{
        ...
        value: function button(action) {
            var API_video = this.state.video;
        ...
        value: function mountVideoPlayer() {
            ...
            var API_video = (0, _video2.default)(this.videoNode, options);
            this.setState({
                video: API_video,
                buttons: this.button
            }, function () {
                // API_video.on("timeupdate",function(){
                //     this.videoTimeUpdate(API_video);                 
                // })
                API_video.on("timeupdate", _this2.videoTimeUpdate());
            });
        }
    }, {
        key: 'videoTimeUpdate',
        value: function videoTimeUpdate() {
            var API_video = this.state.video;
            var duration = API_video.duration();
            var time = API_video.scrubbing() ? API_video.getCache().currentTime : API_video.currentTime();
            this.setState({
...
var window = _interopDefault(__webpack_require__(425));
var document = _interopDefault(__webpack_require__(428));
var tsml = _interopDefault(__webpack_require__(430));
var safeParseTuple = _interopDefault(__webpack_require__(431));
var xhr = _interopDefault(__webpack_require__(432));
var vtt = _interopDefault(__webpack_require__(437));
...
var minDoc = __webpack_require__(429);
...
var xtend = __webpack_require__(436)
...
var trim = __webpack_require__(434)
...
var vttjs = module.exports = {
  WebVTT: __webpack_require__(438),
  VTTCue: __webpack_require__(439),
  VTTRegion: __webpack_require__(440)
};
